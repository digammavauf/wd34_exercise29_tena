                ...
                <div className="mb-4 col-md-6 mx-auto">
                    <form>
                        <div className="input-group mb-2">
                            <label className="input-group-text col-4" id="name-label" for="name">Name</label>
                            <input type="text" className="form-control col-4" name="name" id="name" arial-aria-describedby="name-label"/>
                        </div>
                        <div className="input-group mb-2">
                            <label className="input-group-text col-4" id="email-label" for="email">Email</label>
                            <input type="email" className="form-control col-4" name="email" id="email" aria-activedescendant="email-label"/>
                            </div>
                        <div className="input-group mb-2">
                            <label className="input-group-text col-4" id="comment-label" for="comment">Comment</label>
                        ...
                        <button className="btn btn-success col-4 offset-4">Submit</button>
                    </form>
                </div>
            </div>
        </div>
